...
<body>
    ...
    // }
    if ($showError) {
    //     echo ' <div class="alert alert-danger alert-dismissible fade show" role="alert" id="danger-alert">
    ...
    <div class="container" style="margin-top: 150px;">
        <h1 class="text-center my-2 mt-500">Login to our website</h1>
        <form action="index.php" autocomplete="on" method="post"
            ...
            <div class="mb-3 col-md-6">
                ...
                <input type="text" required autofocus maxlength="30" class="form-control" id="username"
                    aria-describedby="emailHelp" name="username" placeholder="Enter your UserId">
            </div>
            <div class="mb-3 col-md-6">
